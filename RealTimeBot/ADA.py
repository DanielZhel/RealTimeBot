...
def update_figure(n_intervals):
    ...
    tl.get_short_entry(macd_values,ema_values,stoch_values,inst_data2, fig, go, "ADA SHORT")
    tl.get_long_entry(macd_values,ema_values,stoch_values,inst_data2, fig, go, "ADA LONG")
