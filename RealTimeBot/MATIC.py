...
def update_figure(n_intervals):
    ...
    inst_data1= dt.get_instrument_data("MATIC-USDT", "30m", 100)
    inst_data2= dt.get_instrument_data("MATIC-USDT", "5m", 300)
    ...
    tl.get_short_entry(macd_values,ema_values,stoch_values,inst_data2, fig, go, "MATIC SHORT")
    tl.get_long_entry(macd_values,ema_values,stoch_values,inst_data2, fig, go, "MATIC LONG")
